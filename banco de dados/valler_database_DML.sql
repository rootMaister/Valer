--Produto - Mateus       - OK
insert into Produto      (id_categoria, id_usuario, nome, descricao) 
values                   (1,2,'Fanta', 'Bebida 2L'), 
                         (1,2,'Coca', 'Bebida 1L'),
                         (2,4,'Batata', 'Alimento fresco'); 
...
VALUES                   (1, 'Prata', '12/09/2019', '20/09/2019', 'R$ 12,00', '1', 'Banana.jpg' ),
                         (2, 'Ouro', '30/08/2019', '05/09/2019', 'R$14,00' , '2' , 'Banana.jpg') ,
                         (3, 'Sem Semente', '10/10/2019', '30/10/2019', 'R$6,00', '1', 'Uva.jpg');

--Reserva - Vinicius    - OK
INSERT INTO Reserva (id_oferta, id_usuario, quantidade_reserva, cronometro, statuss)
VALUES                   ('1',  2, '3', '15H', 'aguardando'),
                         ('2',  2, '2', '14H', 'aguardando'),
                         ('3',  3, '5', '12H', 'finalisado');
